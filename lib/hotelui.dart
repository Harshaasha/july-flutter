...
void main() {
  runApp(MaterialApp(home: mainusesliver(),));
}
...
class _mainusesliverState extends State<mainusesliver> {
  ...
  var review = ["220 reviews", "234 reviews", "125 reviews",];
  var image = [
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  SizedBox(width: 15.0,),
                  Container(decoration: BoxDecoration(color: Colors.red[200],),
                    height: 80,
                    width: 80,
                  ...
                  Container(decoration: BoxDecoration(color: Colors.blue[200]),
                    ...
                    width: 80,
                    child: Column(mainAxisAlignment: MainAxisAlignment.center,
                      children: [Icon(Icons.restaurant),
                        Text("Resturent")],
                    ),),
                  SizedBox(width: 15.0,),
                  Container(
                    ...
                    width: 80,
                    child: Column(mainAxisAlignment: MainAxisAlignment.center,
                      children: [Icon(Icons.local_cafe),
                        Text("Cafe")],
                    ),),
